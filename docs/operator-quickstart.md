# Operator Quickstart — Community Industrial Machinery Repair Operations

Shortest path from clone to a verified local dry-run for **ISIC 3312** (`cloud-itonami-isic-3312`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-3312.git
cd cloud-itonami-isic-3312
```
...
- Blueprint governor key: `machinery-repair-governor`
- Likely source path: `machinery_repair.governor.cljc`
