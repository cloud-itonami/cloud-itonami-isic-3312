...
This project handles repair-authority-scope, certification-scope and
release-record workflows. Treat vulnerabilities as potentially high
...
- repair-authority/certification credential exposure
- real repair or equipment data exposure
- authorization bypass
- Machinery Repair Governor bypass
